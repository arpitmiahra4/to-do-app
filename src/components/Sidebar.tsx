  ...
  return (
    <Container>
      ...
      >
        ...
        >
          <Logo src={"https://www.iconarchive.com/download/i144851/gartoon-team/gartoon-apps/gtodo-todo-list.1024.png"} alt="logo" />
          <h2>
            <span style={{ color: "#7764E8" }}>To-do</span> App
        ...
        <StyledMenuItem
          translate="no"
          onClick={() => {
            window.open("https://github.com/arpitmiahra4/to-do-app");
          }}
        >
          <GitHub /> &nbsp; Github{" "}
          {stars && (
        ...
        <StyledMenuItem
          onClick={() => {
            window.open("https://github.com/arpitmiahra4/to-do-app/issues/new");
          }}
        >
